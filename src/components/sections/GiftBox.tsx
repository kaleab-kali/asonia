...
const GIFTS: GiftData[] = [
    ...
    },
    {
        ...
        message: "Some surprises are worth the wait... This gift is coming soon, just like more amazing things heading your way this year!",
        emoji: "🎁"
    }
];
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="text-center mb-10 md:mb-14">
                    ...
                    <p className="font-montserrat text-soft-black/60 text-sm">
                        Three special surprises waiting just for you
                    </p>
                </div>
